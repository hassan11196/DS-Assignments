...
class maze_arr : dyn_2d_safe_arr<maze_block>{
};
...
class maze_block{
	public:
		...
		static void print_solved(dyn_2d_safe_arr<maze_block> maze){
			int flag = 0;
			int r = 0, c = 0;
...
void path_finder(dyn_2d_safe_arr<maze_block> &obj){
	int r = 0, c = 0;
