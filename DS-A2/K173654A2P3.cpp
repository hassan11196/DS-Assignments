...
bool POS(float arrival_rate,int avg_service_time_min,int avg_service_time_max,long int total_time){
	...
	ofstream p("A2-IO-Cases\\A2-IO-Cases\\A2P3-in-01myOUT.txt");
	...
	for(int i = 0 ;i < num_hours; i ++){
		...
		(*out) << endl << "Number of Customers : " << part_customers
	...
	(*out) << endl << "Overall : " << endl
		   << endl << "Numeber of Total Customers : " << total_customers << endl;
	(*out) << endl << "Arrival Rate : " << arrival_rate << "(no. of customers / sec) or " <<  arrival_rate*60*60 << "(no. of customers / hours)"  
